...
@section('title', 'Split - Edit')
@section('pagetitle', 'Split - Edit')
...
{!! Form::open(['url' => action('SplitController@update', [$record->id]), 'method' => 'put', 'files' => true]) !!}
...
<div class="row">
	...
	<div class="col-xs-12 col-sm-12">
		<h5>Rate</h5>
		{!! Form::text('rate', $record->rate, ['class' => 'form-control', 'autocomplete' => 'off']) !!}
...
{!! Form::open(['url' => action('SplitController@destroy', [$record->id]), 'method' => 'delete']) !!}
